...
-----+------------+-------------+---------------+---------+-------------+------+----------------+-------+------------+-----------------+--------------------+---------------------+----------------------
  ...
  24 | 2021-04-27 |           1 | 1             |      29 |           2 |    5 |              2 |     2 |          8 |           0.172 |              0.226 |               0.345 |                0.571
...
----------------------------------------------------------------------------------------------------------------------------------------------
-- In the above results, both models incorrectly predicted Keys 42 and 25.

-- On Key 42, the Team scored 5 runs, so it's not surprising that both models incorrectly predicted Win.
...
-- On Key 31, the Team scored 5 runs, so it's not surprising SVM incorrectly predicted Win, but RF correctly predicted Loss.
...
-- On Key 24 and 67, the Team only scored 2 runs, so it's not surprising SVM incorrectly predicted Loss, but RF correctly predicted Win.
