...
DROP MODEL IF EXISTS BRS_2016_2021_WP_Game_Day_of_Week_OneHotModel;

SELECT ONE_HOT_ENCODER_FIT ('BRS_2016_2021_WP_Game_Day_of_Week_OneHotModel',
                            'BRS_2016_2021_WP_input',
                            'Game_Day_of_Week');


DROP TABLE IF EXISTS BRS_2016_2021_WP_Game_Day_of_Week_encoded;

CREATE TABLE BRS_2016_2021_WP_Game_Day_of_Week_encoded 
...
FROM (SELECT APPLY_ONE_HOT_ENCODER(* USING PARAMETERS model_name='BRS_2016_2021_WP_Game_Day_of_Week_OneHotModel', drop_first='false') FROM BRS_2016_2021_WP_input) AS Coming_In_Hot;


DROP MODEL IF EXISTS BRS_2016_2021_WP_Game_Day_of_Week_LOGREGModel;

SELECT LOGISTIC_REG ('BRS_2016_2021_WP_Game_Day_of_Week_LOGREGModel', 
                     'BRS_2016_2021_WP_Game_Day_of_Week_encoded', 
                     'Game_Result',
...
DROP TABLE IF EXISTS BRS_2016_2021_WP_Game_Day_of_Week_probability;

CREATE TABLE BRS_2016_2021_WP_Game_Day_of_Week_probability 
AS (SELECT DISTINCT Team, 'Game_Day_of_Week' AS Game_Metric_Type, Game_Day_of_Week AS Game_Metric_Value,
           ...
           USING PARAMETERS model_name='BRS_2016_2021_WP_Game_Day_of_Week_LOGREGModel', type = 'probability') AS Win_Probability  
    FROM BRS_2016_2021_WP_Game_Day_of_Week_encoded);
