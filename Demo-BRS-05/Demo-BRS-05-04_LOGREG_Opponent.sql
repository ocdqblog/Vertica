...
DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Opponent_OneHotModel;

SELECT ONE_HOT_ENCODER_FIT ('BRS_2016_2021_ODMD_Opponent_OneHotModel',
                            'BRS_2016_2021_ODMD_input',
                            'Opponent');


DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Opponent_encoded;

CREATE TABLE BRS_2016_2021_ODMD_Opponent_encoded 
...
FROM (SELECT APPLY_ONE_HOT_ENCODER(* USING PARAMETERS model_name='BRS_2016_2021_ODMD_Opponent_OneHotModel', drop_first='false') FROM BRS_2016_2021_ODMD_input) AS Coming_In_Hot;


DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Opponent_LOGREGModel;

SELECT LOGISTIC_REG ('BRS_2016_2021_ODMD_Opponent_LOGREGModel', 
                     'BRS_2016_2021_ODMD_Opponent_encoded', 
                     'Game_Result',
...
DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Opponent_probability;

CREATE TABLE BRS_2016_2021_ODMD_Opponent_probability 
AS (SELECT DISTINCT Team, 'Opponent' AS Game_Metric_Type, Opponent AS Game_Metric_Value,
           ...
           USING PARAMETERS model_name='BRS_2016_2021_ODMD_Opponent_LOGREGModel', type = 'probability') AS Win_Probability  
    FROM BRS_2016_2021_ODMD_Opponent_encoded);
