...
DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Opponent_Division_OneHotModel;

SELECT ONE_HOT_ENCODER_FIT ('BRS_2016_2021_ODMD_Opponent_Division_OneHotModel',
                            'BRS_2016_2021_ODMD_input',
                            'Opponent_Division');


DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Opponent_Division_encoded;

CREATE TABLE BRS_2016_2021_ODMD_Opponent_Division_encoded 
...
FROM (SELECT APPLY_ONE_HOT_ENCODER(* USING PARAMETERS model_name='BRS_2016_2021_ODMD_Opponent_Division_OneHotModel', drop_first='false') FROM BRS_2016_2021_ODMD_input) AS Coming_In_Hot;


DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Opponent_Division_LOGREGModel;

SELECT LOGISTIC_REG ('BRS_2016_2021_ODMD_Opponent_Division_LOGREGModel', 
                     'BRS_2016_2021_ODMD_Opponent_Division_encoded', 
                     'Game_Result',
...
DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Opponent_Division_probability;

CREATE TABLE BRS_2016_2021_ODMD_Opponent_Division_probability 
AS (SELECT DISTINCT Team, 'Opponent_Division' AS Game_Metric_Type, Opponent_Division AS Game_Metric_Value,
           ...
           USING PARAMETERS model_name='BRS_2016_2021_ODMD_Opponent_Division_LOGREGModel', type = 'probability') AS Win_Probability  
    FROM BRS_2016_2021_ODMD_Opponent_Division_encoded);
