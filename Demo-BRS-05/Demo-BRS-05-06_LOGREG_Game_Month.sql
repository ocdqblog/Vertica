...
DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Game_Month_OneHotModel;

SELECT ONE_HOT_ENCODER_FIT ('BRS_2016_2021_ODMD_Game_Month_OneHotModel',
                            'BRS_2016_2021_ODMD_input',
                            'Game_Month');


DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Game_Month_encoded;

CREATE TABLE BRS_2016_2021_ODMD_Game_Month_encoded 
...
FROM (SELECT APPLY_ONE_HOT_ENCODER(* USING PARAMETERS model_name='BRS_2016_2021_ODMD_Game_Month_OneHotModel', drop_first='false') FROM BRS_2016_2021_ODMD_input) AS Coming_In_Hot;


DROP MODEL IF EXISTS BRS_2016_2021_ODMD_Game_Month_LOGREGModel;

SELECT LOGISTIC_REG ('BRS_2016_2021_ODMD_Game_Month_LOGREGModel', 
                     'BRS_2016_2021_ODMD_Game_Month_encoded', 
                     'Game_Result',
...
DROP TABLE IF EXISTS BRS_2016_2021_ODMD_Game_Month_probability;

CREATE TABLE BRS_2016_2021_ODMD_Game_Month_probability 
AS (SELECT DISTINCT Team, 'Game_Month' AS Game_Metric_Type, Game_Month AS Game_Metric_Value,
           ...
           USING PARAMETERS model_name='BRS_2016_2021_ODMD_Game_Month_LOGREGModel', type = 'probability') AS Win_Probability  
    FROM BRS_2016_2021_ODMD_Game_Month_encoded);
